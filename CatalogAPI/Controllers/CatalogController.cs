...
namespace CatalogAPI.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public ActionResult<CatalogItem> AddProduct()
        {
            ...
            BackupToTableAsync(catalogItem);
            return catalogItem;          
        }
        ...
        async Task<CatalogEntity> BackupToTableAsync(CatalogItem item)
        {
            ...
            storageAccountHelper.TableConnectionString = config.GetConnectionString("TableConnection");
            return await storageAccountHelper.SaveToTableAsync(item);
        }
    }
}